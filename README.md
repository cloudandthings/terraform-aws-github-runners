...
| <a name="input_github_personal_access_token_secretsmanager_secret_arn"></a> [github\_personal\_access\_token\_secretsmanager\_secret\_arn](#input\_github\_personal\_access\_token\_secretsmanager\_secret\_arn) | The Secret ARN containing the credentials to use for the region-wide CodeBuild Source Credential. See `docs/GITHUB-AUTH-SETUP.md` for more information. | `string` | `null` | no |
